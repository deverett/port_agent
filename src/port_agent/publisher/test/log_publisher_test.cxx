...
TEST_F(LogPublisherTest, SingleBinaryOut) {
    ...
    char result[1024];
    int count;
    char expected[20] = { 0xa3, 0x9d, 0x7a,  0x03, 0x00,  0x14, 0x00,  0xc2,  0x00,  0x00,
...
TEST_F(LogPublisherTest, DoubleBinaryOut) {
    ...
    char result[1024];
    int count;
    char expected[40] = { 0xa3, 0x9d, 0x7a,  0x03, 0x00,  0x14, 0x00,  0xc2, 0x00, 0x00,
                          0x00, 0x01,  0x80, 0x00,  0x00,  0x00, 0x64, 0x61, 0x74, 0x61,
                          0xa3, 0x9d, 0x7a,  0x03, 0x00,  0x14, 0x00,  0xc2, 0x00, 0x00,
                		  0x00, 0x01,  0x80, 0x00,  0x00,  0x00, 0x64, 0x61, 0x74, 0x61 };
